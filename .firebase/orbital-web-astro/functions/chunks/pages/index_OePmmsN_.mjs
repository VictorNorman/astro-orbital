...
const $$IntegralsTab = createComponent(async ($$result, $$props, $$slots) => {
  ...
  const items = await Astro2.glob(/* #__PURE__ */ Object.assign({"../scripts/integrals/01.md": () => import('../01_5aJp0TeP.mjs'),"../scripts/integrals/02.md": () => import('../02_Zb_CUr66.mjs'),"../scripts/integrals/03.md": () => import('../03_C_dWmUsx.mjs'),"../scripts/integrals/04.md": () => import('../04_Q1udtgMq.mjs'),"../scripts/integrals/05.md": () => import('../05_SFekQ6Gn.mjs'),"../scripts/integrals/06.md": () => import('../06_eyEE_Xuh.mjs'),"../scripts/integrals/07.md": () => import('../07_Jl3MWRM5.mjs'),"../scripts/integrals/08.md": () => import('../08_ALc2flcT.mjs'),"../scripts/integrals/09.md": () => import('../09_Ez3X2WM1.mjs'),"../scripts/integrals/10.md": () => import('../10_q4DrgqU1.mjs')}), () => "../scripts/integrals/*.md");
  return renderTemplate`${renderComponent($$result, "TabLayout", $$TabLayout, { "tabName": "Integrals", "id": "tab4" }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<div> <!-- There is only one item in the items array. --> ${items.map(({ file, Content }) => renderTemplate`${renderComponent($$result2, "Fragment", Fragment, {}, { "default": ($$result3) => renderTemplate` ${renderComponent($$result3, "Content", Content, {})} ` })}`)} <div style="display: none" id="no-integrals-tables-to-show">
No Integrals Info available.
</div> </div> <p></p> ` })} `;
}, "/Users/vtn2/src/astro-orbital/src/components/IntegralsTab.astro", void 0);
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$Index;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Orbital Energy", "data-astro-cid-j7pv25f6": true }, { "default": ($$result2) => renderTemplate` ${maybeRenderHead()}<main data-astro-cid-j7pv25f6> <span class="version" data-astro-cid-j7pv25f6> Version 17 Jan 2024</span> <h1 data-astro-cid-j7pv25f6>Orbital Energy</h1> ${renderComponent($$result2, "TopTable", $$TopTable, { "data-astro-cid-j7pv25f6": true })} <div id="matrices" class="horizontal-flex" data-astro-cid-j7pv25f6> <!-- <table id="dynamic23Matrix"></table>
